...
bool GetMyExternalIP(CNetAddr& ipRet)
{
    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            addrConnect = CService("91.241.174.7",80); // checkip.dyndns.org
        ...
        {
            addrConnect = CService("148.251.8.18", 80); // www.showmyip.com
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("SportsCoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SportsCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"63.142.255.39", "63.142.255.39"},	
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("SportsCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("SportsCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("SportsCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("SportsCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SportsCoin is probably already running."), addrBind.ToString().c_str());
        else
